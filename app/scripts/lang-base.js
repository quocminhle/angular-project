var lang_js = (function(){
	return {
		en:{
			...
			MESSAGE_REQUIRE_LOGIN: 'You are not logged in.',
			MESSAGE_LOGIN_FACEBOOK: 'You are not logged in facebook.',
			MESSAGE_REQUIRE_ROLE: 'You do not have permission to access this page.',
			EVENT_STOP: 'Time in the program is over, thank you for your interest.',
