...
<div id="mdl-home" class="mdl">
	<div class="container">
		<h1>Home</h1>
		<h3>Paging</h3>
		<st-pager page-state="home" page-params="home.queryParams"></st-pager>
		<h3>Popup</h3>
		<a ng-click="home.popupVideo()" class="btn btn-primary">Video Popup</a>
		<a ng-click="home.popupGalleryImage()" class="btn btn-primary">Popup Gallery Image</a>
		<a ng-click="home.popupGalleryInline()" class="btn btn-primary">Popup Gallery Inline</a>
		<br>
		<h3>Form</h3>
		<div class="row">
			<div class="col-md-4">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="st-calendar" st-calendar>
					<select id="c-month">
